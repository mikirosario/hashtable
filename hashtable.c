...
int	main(void)
{
	...
	ht_init(&hashtable);
	ht_set(&hashtable, "name1", "madrid");
	ht_set(&hashtable, "name2", "cataluña");
	ht_set(&hashtable, "name3", "valencia");
	ht_set(&hashtable, "name4", "euskadi");
	ht_set(&hashtable, "name5", "navarra");
	ht_set(&hashtable, "name6", "cataluña");
	ht_set(&hashtable, "name7", "la rioja");
	ht_set(&hashtable, "name8", "asturias");
	ht_set(&hashtable, "name9", "cantabria");
	ht_set(&hashtable, "name10", "galicia");
	ht_set(&hashtable, "name11", "castilla y león");
	ht_set(&hashtable, "name12", "castilla la mancha");
	ht_set(&hashtable, "name13", "andalucía");
	ht_set(&hashtable, "name14", "extremadura");
	ht_set(&hashtable, "name15", "murcia");
	ht_set(&hashtable, "name16", "canarias");
	ht_set(&hashtable, "name17", "baleares");
	ht_set(&hashtable, "name18", "ceuta");
	ht_set(&hashtable, "name19", "melilla");
